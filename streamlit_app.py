...
CSV_PATH = "complaints_coverage_singapore.csv"
GEOJSON_PATH = "singapore_planning_area.geojson"
...
def build_payload():
    ...
    # Summary (keep keys same as dashboard)
    ...
    summary = {
        ...
        "total_submitted": int(status_counts.get("Open", 0)),
        "total_in_progress": int(status_counts.get("In Progress", 0)),
        "total_resolved": int(status_counts.get("Closed", 0)),
    }
    ...
    # State-Status matrix (Singapore order)
